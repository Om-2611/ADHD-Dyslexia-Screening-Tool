...
async function getQuestionStats() {
    try {
        ...
        for (const [subcategory, counts] of Object.entries(stats)) {
            const label = subcategoryLabels[subcategory];
            ...
            console.log(`║ ${label.padEnd(30)} ║ ${behavioralStatus.padStart(11)} ║ ${performanceStatus.padStart(12)} ║ ${String(counts.total).padStart(5)} ║`);
        }
        console.log('╚════════════════════════════════╩═══════════════╩════════════════╩═══════╝');
    }
    catch (error) {
